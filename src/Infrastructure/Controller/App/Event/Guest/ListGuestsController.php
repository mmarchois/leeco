...
namespace App\Infrastructure\Controller\App\Event\Guest;
...
final class ListGuestsController extends AbstractEventController
{
    ...
    #[Route(
        '/events/{eventUuid}/guests/{page}',
        name: 'app_guests_list',
    ...
    public function __invoke(Request $request, string $eventUuid, int $page = 1): Response
    {
        ...
        $paginatedGuests = $this->queryBus->handle(
            new GetGuestsByEventQuery($event->getUuid(), $page, $pageSize),
        );

        return new Response(
            content: $this->twig->render(
                name: 'app/guest/list.html.twig',
                context : [
