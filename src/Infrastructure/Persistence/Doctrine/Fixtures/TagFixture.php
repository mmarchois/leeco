...
final class TagFixture extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $tag1 = new Tag(
            ...
            new \DateTime('2019-01-05 19:00:00', $this->clientTimezone),
            new \DateTime('2019-01-05 21:00:00', $this->clientTimezone),
        ...
        $tag2 = new Tag(
            ...
            'Dîner',
            new \DateTime('2019-01-05 20:00:00', $this->clientTimezone),
            new \DateTime('2019-01-05 22:00:00', $this->clientTimezone),
            $this->getReference('event'),
        );
        ...
        $tag3 = new Tag(
            ...
            'Bubble foot',
            new \DateTime('2023-05-05 08:00:00', $this->clientTimezone),
            new \DateTime('2023-05-10 23:00:00', $this->clientTimezone),
