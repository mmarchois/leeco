...
final class SendConfirmationMailCommandHandlerTest extends TestCase
{
    public function testSendConfirmationLink(): void
    {
        ...
        $commandBus
            ->expects(self::once())
            ->method('handle')
            ->with(new CreateTokenCommand('mathieu.marchois@gmail.com', TokenTypeEnum::CONFIRM_ACCOUNT->value))
            ->willReturn('myToken');
        ...
        $mail
            ...
            ->with(
                $this->equalTo(
                    new Mail(
                        address: 'mathieu.marchois@gmail.com',
        ...
        ($handler)(new SendConfirmationMailCommand('   mathieu.marchois@gmail.com  '));
    }
    ...
    public function testUserNotFound(): void
    {
        ...
        $handler = new SendConfirmationMailCommandHandler($commandBus, $mail);
        $command = new SendConfirmationMailCommand('   mathieu.marchois@gmail.com   ');
        ($handler)($command);
    }
}
